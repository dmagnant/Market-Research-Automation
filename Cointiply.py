...
def Cointiply(driver):
    ...
    while still_ads:
        ...
        if num_avail_coins > 0:
            ...
            myScreenshot.save(directory + r"\Projects\Coding\captcha images\captcha_shot.png")
            # select proper template based on selection
            if selection == "Anchovies":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\anchovies.png")
            elif selection == "Apple":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\apple.png")
            elif selection == "Beaker":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\beaker.png")
            elif selection == "Bolts of Cloth":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\bolts of cloth.png")
            elif selection == "Bones":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\bones.png")
            elif selection == "Bucket":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\bucket.png")
            elif selection == "Carrot":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\carrot.png")
            elif selection == "Cheese":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\cheese.png")
            elif selection == "Chocolate":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\chocolate.png")
            elif selection == "First Aid Kit":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\first aid kit.png")
            elif selection == "Fish":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\fish.png")
            elif selection == "Jerry Can":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\jerry can.png")
            elif selection == "Keys":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\keys.png")
            elif selection == "Lock Box":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\lock box.png")
            elif selection == "Medecine":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\medicine.png")
            elif selection == "Mushroom":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\mushroom.png")
            elif selection == "Ointment":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\ointment.png")
            elif selection == "Paint":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\paint.png")
            elif selection == "Peanut":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\peanut.png")
            elif selection == "Pen":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\pen.png")
            elif selection == "Pencil":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\pencil.png")
            elif selection == "Pills":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\pills.png")
            elif selection == "Sack":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\sack.png")
            elif selection == "Small Lollipop":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\small lollipop.png")
            elif selection == "Steak":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\steak.png")
            elif selection == "Syringe":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\syringe.png")
            elif selection == "Tire":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\tire.png")
            elif selection == "Turkey Leg":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\turkey leg.png")
            elif selection == "Wallet":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\wallet.png")
            elif selection == "Wooden Logs":
                template = cv2.imread(directory + r"\Projects\Coding\captcha images\wooden logs.png")
            else:
                MessageBox = ctypes.windll.user32.MessageBoxW
            ...
            img = cv2.imread(directory + r"\Projects\Coding\captcha images\captcha_shot.png")
            img2 = img.copy()
